...
Market-implied probability of each fed funds target-range outcome at the
next scheduled FOMC meeting, backed out of 30-Day Fed Funds futures (ZQ)
prices. Refreshed daily.

```{raw} html
<iframe src="_static/amazingmazy--fedwatch_monitor/fedwatch_latest_forecast.html" height="500px" width="100%"></iframe>
```
...
:maxdepth: 1
:caption: Notebooks 📖
30-Day Fed Funds Futures Data from Databento <cb/notebooks/amazingmazy--fedwatch_monitor/01_fed_funds_futures_data>
Replicating the CME FedWatch Tool <cb/notebooks/amazingmazy--fedwatch_monitor/02_fedwatch_replication>
```
...
cb/dataframes/amazingmazy--fedwatch_monitor/fed_funds_futures.md
```
...
| Date of Last Code Update        | 2026-08-22 09:44:46           |
| OS Compatibility                | Windows, Linux, macOS |
| Linked Dataframes               |  [amazingmazy/fedwatch_monitor:fed_funds_futures](cb/dataframes/amazingmazy--fedwatch_monitor/fed_funds_futures.md)<br>  |
